...
// EJERCICIO 3: Validación del formulario en cliente con Javascript 
// (después de la validación de HTML5)
    function validateForm() {
		// Comprobar que la longitud de la contraseña es >=8, 
	...
	// EJERCICIO 3.1: Comprobar la restricciones del password 
    // y aplicar clases CSS mediante JQuery
	function passwordValidation(){
		...
		// Comprobamos si contiene letras mayúsculas, 
		...
		// Si no cumple las restricciones, devuelve un error
		if(!valid){
	...
	// EJERCICIO 3.2: Campos de contraseña 
    // y confirmación de contraseña iguales
	...
	// EJERCICIO 2: Calcula la fortaleza de una contraseña: 
    // frecuencia de repetición de caracteres
	function passwordStrength(password){
    		...
    		// Devolvemos el cociente entre el número de caracteres únicos 
            // (las claves del Map) y la longitud de la contraseña
